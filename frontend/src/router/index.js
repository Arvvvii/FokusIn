  ...
  routes: [
    ...
    // Tutor Routes
    {
      ...
      children: [
        ...
        { path: 'notifications', name: 'tutor-notifications', component: () => import('@/pages/shared/ComingSoonView.vue') },
      ]
    },
    // Admin Routes
    {
      ...
      children: [
        ...
        { path: 'tutors', name: 'admin-tutors', component: () => import('@/pages/admin/ManageUsersView.vue') },
        { path: 'reports', name: 'admin-reports', component: () => import('@/pages/admin/ManageReportsView.vue') },
        { path: 'moderation', name: 'admin-moderation', component: () => import('@/pages/admin/ManageReportsView.vue') },
        { path: 'materials', name: 'admin-materials', component: () => import('@/pages/pelajar/MaterialsView.vue') },
        { path: 'mentoring', name: 'admin-mentoring', component: () => import('@/pages/admin/DashboardAdminView.vue') },
        { path: 'quiz-monitoring', name: 'admin-quiz-monitoring', component: () => import('@/pages/admin/DashboardAdminView.vue') },
        ...
        { path: 'profile', name: 'admin-profile', component: () => import('@/pages/admin/DashboardAdminView.vue') },
        { path: 'settings', name: 'admin-settings', component: () => import('@/pages/admin/DashboardAdminView.vue') },
      ]
    },
  ],
})
