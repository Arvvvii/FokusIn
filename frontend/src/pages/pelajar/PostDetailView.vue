      ...
      <div class="w-full xl:w-[75%] space-y-8">
        ...
        <div class="bg-white/80 backdrop-blur-xl rounded-3xl p-6 shadow-[0_10px_40px_rgba(15,23,42,0.06)] border border-slate-100 mt-8 transition-all duration-300 ease-out hover:shadow-xl group/card">
          ...
          <div class="flex justify-end mt-5">
            <button @click="submitAnswer" class="px-8 py-3 bg-[#334EAC] hover:bg-[#081F5C] text-white rounded-2xl font-bold text-[15px] transition-all shadow-[0_4px_15px_rgba(51,78,172,0.2)] active:scale-95">
              Kirim Jawaban
            </button>
          </div>
        </div>
...
const submitAnswer = () => {
  ...
  alert('Fitur pengiriman jawaban belum didukung oleh sistem API saat ini (Backend Gap).')
}
</script>
