    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 xl:px-8 pt-6 pb-12 space-y-6">
      ...
      <div class="bg-white/80 backdrop-blur-xl rounded-3xl p-7 md:p-8 shadow-[0_10px_40px_rgba(15,23,42,0.06)] border border-white/40 relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
        ...
        <div class="relative z-10 flex items-center gap-4">
          <RouterLink to="/tutor/dashboard" class="w-10 h-10 rounded-xl bg-white border border-slate-200 text-slate-500 hover:text-[#334EAC] hover:border-[#7096D1] flex items-center justify-center transition-all shadow-sm active:scale-95 shrink-0" title="Kembali">
          ...
          <div>
            <h1 class="text-2xl md:text-3xl font-bold text-slate-900 tracking-tight leading-none mb-1">Statistik & Analisis Mentor</h1>
