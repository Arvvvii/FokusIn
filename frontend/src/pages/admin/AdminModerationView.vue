  ...
  <div class="p-6 md:p-8 xl:p-10 max-w-[1600px] mx-auto animate-in fade-in duration-500">
    ...
    <div class="bg-white/80 backdrop-blur-xl rounded-3xl p-7 md:p-8 shadow-[0_10px_40px_rgba(15,23,42,0.06)] border border-white/40 relative overflow-hidden mb-8">
      <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 relative z-10">
        <div>
          <h1 class="text-[28px] font-bold text-slate-900 tracking-tight mb-1">Live Content Moderation</h1>
          <p class="text-base text-slate-500 font-medium">Antrean moderasi forum, pembersihan otomatis AI, dan tinjauan persetujuan konten publik.</p>
        </div>
        <div class="flex items-center gap-4">
          <button class="px-5 py-2.5 bg-indigo-600 text-white rounded-xl font-semibold text-sm shadow-sm hover:bg-indigo-700 transition-all flex items-center gap-2">
    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      <div class="p-6 border-b border-slate-100 flex items-center justify-between">
        ...
        <div class="flex gap-2">
          <input type="text" placeholder="Search content..." class="px-4 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-indigo-500" />
        </div>
      </div>
